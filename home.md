            ...
            <div class="col-lg-12">
                <div class="col-lg-3 col-lg-offset-2">
                    ...
                    <ul >
                        ...
                        <li><strong><a href="https://github.com/Flexget/Flexget/discussions">Forum</a></strong></li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    ...
                    <p>For support and help use the <a href="https://github.com/Flexget/Flexget/discussions">Flexget Forums</a></p>
        ...
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1 text-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p>We're seeking new developers for <a href="/Web-UI">web interface</a>. Python and Typescript/React developers are all needed. Join us for chat and discussions via your preferred chat client if you are up for the task. See all methods <a href="/Chat">here</a></p>
                </div>
                <div class="col-lg-6">
                    <h3>Donate</h3>
