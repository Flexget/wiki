...
||[http://download.flexget.com/0.9/FlexGet_0.9.2.2.zip FlexGet v0.9.2.2]||02.03.2009||'''Critical update for 0.9.2.1 - Fixes url encoding with parameters'''. Fixes download from urls that need encoding.[[BR]]v0.9.2 Fixed #213, #212, #208, #207, #201, #182, #203, #99, #103, #188, #192, #193, #196.[[BR]]Also included fixes for FilterSeries settings block and InputRlsLog combined with FilterImdb.||
