...
{{{
flexget --movie-queue (add|del|list|clear) [NAME|imdb_id=IMDB_ID|tmdb_id=TMDB_ID] [QUALITY] [FORCE]
}}}
...
In the event that you have accidentally managed to fill your movie_queue with a bunch of movies (perhaps with wrong settings) you can clear the whole thing.
