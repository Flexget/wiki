...
Another popupal option is to use [series_metainfo](/Plugins/series_metainfo) plugin based parsing that does not require series plugin with explicit series names. However it is not as accurate as series plugin with explicit names.