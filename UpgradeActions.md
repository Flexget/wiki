...
- Backwards compatibility with old system has been taken out, it wasn't working quite properly anyway. You cannot use the individual notifiers at task level anymore. You must use the [notify](/Plugins/notify) plugin.
