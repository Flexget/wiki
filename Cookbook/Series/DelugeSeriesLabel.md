...
'''NOTE:''' As of r1840 this recipe is not needed as the [wiki:Plugins/deluge deluge] plugin will replace any invalid characters in the label name with '_' automatically. Also, the [wiki:Plugins/format_field format_field] plugin can now be used to make this sort of replacement much easier.
