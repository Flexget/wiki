This is a comprehensive guide on how to setup an ubuntu box as a seedbox with flexget and deluge. by working through this guide, you can have an automated torrenting setup with the following features:
