...
The following is a comprehensive guide on how to setup an ubuntu/linux box with flexget and deluge. By working through this guide, you can have an automated torrenting setup with the following features:
